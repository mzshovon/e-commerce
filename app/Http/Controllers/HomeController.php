...
class HomeController extends Controller
{
	...
	select('tbl_products.*','tbl_category.category_name','tbl_manufacture.manufacture_name')->
    	...
    	return view('welcome')->with('pages.home_content',$manage_published_product);
    ...
    select('tbl_products.*','tbl_manufacture.manufacture_name')->
        ...
        return view('welcome')->with('pages.category_by_product',$manage_product_by_category);
    ...
    select('tbl_products.*','tbl_category.category_name')->
        ...
        return view('welcome')->with('pages.manufacture_by_product',$manage_product_by_manufacture);
    ...
    where('tbl_products.product_id',$product_id)->
        where('tbl_products.publication_status',1)->first();

        $manage_product_by_details=view('pages.product_details')->with('product_by_details',$product_by_details);
        return view('welcome')->with('pages.product_details',$manage_product_by_details);
