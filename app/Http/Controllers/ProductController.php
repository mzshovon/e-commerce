...
public function all_product(){
	...
	select('tbl_products.*','tbl_category.category_name','tbl_manufacture.manufacture_name')->get();

    	$manage_product=view('admin.all_product')->with('all_product_info',$all_product_info);
    	return view('admin.admin_dashboard')->with('admin.all_product',$manage_product);
}
