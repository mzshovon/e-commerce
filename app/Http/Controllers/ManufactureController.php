...
class ManufactureController extends Controller
{
  ...
  public function all_manufacture(){
    $this->AdminAuthCheck();
    	...
    	return view('admin.admin_dashboard')->with('admin.all_manufacture',$manage_manufacture);
    ...
    public function edit_manufacture($manufacture_id){
    	...
    	return view('admin.admin_dashboard')->with('admin.edit_manufacture',$manufacture_info);
 ...
 public function AdminAuthCheck(){
        ...
        if($admin_id){
            ...
            //send() forcely get you out from the page
        }
