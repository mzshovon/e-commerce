						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td><img src="{{URL::to($v_product->product_image)}}" style="height: 60px; width: 60px"></td>
								<td class="center">{{$v_product->product_price}} Taka</td>
								<td class="center">{{$v_product->category_name}}</td>
								<td class="center">{{$v_product->manufacture_name}}</td>
								<td class="center">
									@if($v_product->publication_status==1)
									<span class="label label-success">{{--{{ $v_category->publication_status}}--}}Active
									</span>
									@else
								...
								<td class="center">
									...
									@endif
									<a class="btn btn-default" href="{{URL::to('/edit_product/'.$v_product->product_id)}}">
										<i class="halflings-icon square edit"></i> 
