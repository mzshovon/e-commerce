						...
						<form class="form-horizontal" action="{{ url('/save-product') }}" method="post" enctype="multipart/form-data" >
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="product_name" value="" required="">
							  </div>
							</div>
                           ...
                           foreach ($all_published_manufacture as $v_manufacture) {
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="product_price" value="" required="">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="product_size" value="" required="">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="product_color" value="" required="">
							  </div>
							</div>
